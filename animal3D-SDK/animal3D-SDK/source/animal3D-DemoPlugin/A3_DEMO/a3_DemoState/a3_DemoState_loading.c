...
void a3demo_loadFramebuffers(a3_DemoState* demoState)
{
	...
	for (i = 0; i < 3; ++i)
	{
		...
		a3framebufferCreate(fbo, "fbo:half", targets_post, colorType_post, a3fbo_depthDisable, frameWidth2, frameHeight2);
		...
		a3framebufferCreate(fbo, "fbo:quarter", targets_post, colorType_post, a3fbo_depthDisable, frameWidth4, frameHeight4);

		
		fbo = demoState->fbo_post_c16_8fr + i;
		a3framebufferCreate(fbo, "fbo:eight", targets_post, colorType_post, a3fbo_depthDisable, frameWidth8, frameHeight8);
