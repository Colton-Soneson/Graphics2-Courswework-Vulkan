...
void a3pipelines_render(a3_DemoState const* demoState, a3_Demo_Pipelines const* demoMode)
{
	...
	const a3_Framebuffer* readFBO[pipelines_pass_max][4] = {
		...
		//I CANT DO THE EIGHTS!!!!! the line uncommented below believes there are too many args
	...
	a3shaderUniformSendFloat(a3unif_vec2, currentDemoProgram->uSize, 1, pixelSize.v);				//LOOK AT USIZE AND USE THAT!!!!!!  THIS IS FLOAT
	...
	//using the provided uAxis for sending the V and H here
